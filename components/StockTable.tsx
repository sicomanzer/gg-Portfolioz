    ...
    <div className="bg-white rounded-lg shadow border border-slate-200 overflow-hidden flex flex-col h-full">
      <div className="overflow-x-auto custom-scrollbar pb-4">
        <table className="w-full text-left border-collapse min-w-[1200px]">
          <thead>
            <tr className="text-xs uppercase tracking-wider text-slate-500 bg-slate-100 border-b border-slate-200">
              ...
              <th className="p-3 text-center w-20 border-r border-slate-200 bg-blue-50/50 text-blue-800">Div (฿)</th>
              <th className="p-3 text-center w-20 border-r border-slate-200 bg-blue-50/50 text-blue-800">Yield %</th>
              <th className="p-3 text-center w-20 border-r border-slate-200 bg-blue-50/50 text-blue-800">Grth (g)</th>
              <th className="p-3 text-center w-20 border-r border-slate-200 bg-blue-50/50 text-blue-800">Req (r)</th>
              <th className="p-3 text-center w-24 border-r border-slate-200 bg-green-50/80 text-green-800">DDM</th>
